...
const data = require('../bitcoinnova-mobile-nodes.json')
...
function checkTestNode (node) {
  ...
  return request({ url: 'https://raw.githubusercontent.com/BitcoinNova/bitcoinnova-mobile-nodes-json/master/bitcoinnova-mobile-nodes.json', json: true })
    .then(data => {
